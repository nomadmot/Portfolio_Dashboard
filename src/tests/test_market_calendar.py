...
from utility.market_calendar import get_closed_count, market_is_open, calculate_begin_date, count_trading_days
...
@patch('utility.market_calendar.sql')
...
def test_count_trading_days():
    ...
    assert count_trading_days(start, end) == 23
